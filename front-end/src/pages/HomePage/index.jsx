        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-5xl font-bold text-gray-800 leading-tight">
              Getting <span className="text-purple-600">Quality</span>
              <br />
              Education is easy
              <br />
            ...
            <div className="flex space-x-4">
              ...
              {user?.role && (
                <button
                  className="px-8 py-3 border-2 border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition-all"
                  onClick={() => navigate(user.role === 'student' ? '/explore/teachers' : '/dashboard')}
                >
                  {user.role === 'student' ? 'Explore Teachers' : 'Go to Dashboard'}
                </button>
              )}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover the features that make our e-learning platform stand out
              from the rest
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex flex-col justify-center items-center text-center bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow"
              >
